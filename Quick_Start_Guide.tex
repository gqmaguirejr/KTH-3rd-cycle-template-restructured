...
Using the GitHub repository enables some automated functions that can help you configure the \texttt{custom\_configuration.tex} file and generate a list of included publications.
