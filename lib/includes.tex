...
%% Colorize
%\usepackage{color}
\PassOptionsToPackage{dvipsnames, svgnames, table, cmyk}{xcolor}
\usepackage{xcolor}
...
\usepackage{enumitem, xcolor}           %% to allow changes to the margins of descriptions and allow the use of xcolor to color the labels
...
\usepackage{tikz}
\usepackage{colortbl}
\usetikzlibrary{arrows,decorations.pathmorphing,backgrounds,fit,positioning, decorations.pathreplacing, calc,shapes, patterns, arrows.meta}
% arrows.meta is a new and improved set of arrows
...
\usepackage{alltt} % for setting everything in a tt font

% To allow the use of subfiles for separate compilation
\usepackage{subfiles}
