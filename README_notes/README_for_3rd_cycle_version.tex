...
\Needspace*{4\baselineskip}
Looking at the printed thesis \textit{Data verification for GNSS systems and protection of GNSS services} by Marco Spanghero, URN: \href{https://urn.kb.se/resolve?urn=urn%3Anbn%3Ase%3Akth%3Adiva-361272}{urn:nbn:se:kth:diva-361272}, ISBN: 978-91-8106-231-1 (print), I found that the positioning of the tabs follows (roughly) the parameters shown in \Cref{lst:myfancytabParameters}.

\Needspace*{12\baselineskip}
\begin{lstlisting}[style=latexExampleForAuthors, caption={Parameters used with myfancytab macro}, label=lst:myfancytabParameters]
...
\Needspace*{7\baselineskip}
The \texttt{fancytabs} package is used with the parameters shown in \Cref{lst:myfancytabParameters}
