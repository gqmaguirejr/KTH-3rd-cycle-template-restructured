...
%% 2026-09-09: Removed support for bibtex; the template now only supports biblatex
...
% Load datatool and babel/polyglossia
\usepackage{datatool}
...
Networking - Artifact for ASPLOS’21\,\cite{10.5281/zenodo.4435970}
    ...
    \warningExpl{When using BibLaTeX, \ref{paper:F} shows an example of how you can easily include the title by simply citing the title field of a reference.\\In contrast, \ref{paper:G} shows how you can use the unicode version of the characters and explicitly control the font used to set them.}
...
\IfFileNotEmpty{lib/thesis_contributions_generated.tex}{\input{lib/thesis_contributions_generated.tex}}
...
% Attach the BibLaTeX for your references to make it easy for a reader to find and use them
The BibLaTeX references used in this thesis are attached.
    \IfFileNotEmpty{referencesUsed.bib}{
...
\IfFileNotEmpty{lib/publications_dividers_generated.tex}{\input{lib/publications_dividers_generated.tex}}
